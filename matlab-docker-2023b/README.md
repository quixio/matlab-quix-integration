...
This code sample demonstrates how to run MATLAB 2023b functions in Quix using a MATLAB Engine instance.

## How to run your MATLAB function

- Save your `.m` function file in the `/MATLAB` directory of this template (like the rot.m example).
